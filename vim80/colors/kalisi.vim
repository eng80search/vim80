...
if &background == "dark"
  ...
  hi CursorLineNr     guifg=#d0d0d0 guibg=#43f220 gui=bold
  hi CursorLine       guibg=#2fca24
  ...
  hi StatusLine       guifg=ffffff guibg=#222222 gui=bold term=NONE cterm=NONE
  ...
  if &t_Co > 255
    ...
    hi CursorLine ctermbg=109 term=none cterm=none
  ...
  hi CursorLineNr     guifg=#000000 guibg=#c9c4c4 gui=bold
  hi Cursorline                     guibg=#e0e0d0
  ...
  hi LineNr           guifg=#009999 guibg=#cccccc gui=bold
